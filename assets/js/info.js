...
function info(){
    ...
    switching_languages_info.style.background = "url("+englishUrl+") center/cover no-repeat"
    ...
    switch (english){
        ...
        case false:
            ...
            switching_languages_info.style.background = "url("+polishUrl+") center/cover no-repeat"
            break;
    }
    english = !english;
    });
